========================================================================
    KONSOLENANWENDUNG: Komposition_Vogel-Projektübersicht
========================================================================

Diese Komposition_Vogel-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Komposition_Vogel-Anwendung besteht.


Komposition_Vogel.vcxproj
...
Komposition_Vogel.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Komposition_Vogel.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
